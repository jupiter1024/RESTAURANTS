...
function evaluateBranchDelivery(branch, customerLat, customerLng) {
  ...
  if (branch.tiers && branch.tiers.length > 0) {
    ...
    const matchedTier = sortedTiers.find((t) => distanceKm >= t.minKm && distanceKm <= t.maxKm) || sortedTiers.find((t) => distanceKm <= t.maxKm) || sortedTiers[sortedTiers.length - 1];
    return {
      covered: true,
      branchId: branch.id,
      branchName: branch.name,
...
// .wrangler/tmp/bundle-j1pwu4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-j1pwu4/middleware-loader.entry.ts
