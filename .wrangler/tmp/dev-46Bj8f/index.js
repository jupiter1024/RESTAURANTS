  ...
  if (orderType === "delivery") {
    if (assignedBranchId) {
      ...
      if (allBranches.length > 0) {
        ...
        const tiers = (await c.env.DB.prepare("SELECT min_km, max_km, fee FROM delivery_distance_tiers WHERE branch_id = ?").bind(bestBranch.id).all()).results;
        const evalResult = evaluateBranchDelivery(
          {
            id: bestBranch.id,
...
// .wrangler/tmp/bundle-bT1k7a/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-bT1k7a/middleware-loader.entry.ts
