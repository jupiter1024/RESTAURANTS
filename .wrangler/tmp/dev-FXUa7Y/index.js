...
pub.post("/orders", async (c) => {
  ...
  const restaurant = await c.env.DB.prepare("SELECT id, name, published FROM restaurants WHERE id = ?").bind(restaurantId).first();
...
// .wrangler/tmp/bundle-rB3wwH/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-rB3wwH/middleware-loader.entry.ts
